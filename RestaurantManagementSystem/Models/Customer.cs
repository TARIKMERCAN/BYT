    ...
    public class Customer : SerializableObject<Customer>
    {
        ...
        public void RemoveOrder(Order order)
        {
            ...
            if (!_orders.Remove(order))
                throw new InvalidOperationException($"Order {order.IdOrder} is not associated with Customer {IdCustomer}.");
        ...
        public Order PlaceOrder(Dish[] dishes)
        {
            ...
            {
                order.AddOrderDish(new OrderDish(dish, 1)); // Default quantity is 1
            }
