...
namespace RestaurantManagementSystem.Models
{
    public class Table : SerializableObject<Table>
    {
        ...
        public Table(int idTable, int numberOfChairs, string tableType)
        {
            ...
            _tableExtent.Add(this); // Add to Extent
        }
        ...
        public void AddReservation(Reservation reservation)
        {
            ...
            reservation.UpdateTable(this); // Reverse connection
            _reservations.Add(reservation);
            OnReservationAdded?.Invoke($"Reservation added to Table {IdTable}.");
            LogAction($"Reservation added to Table {IdTable}.");
        }
        ...
        public bool RemoveReservation(Reservation reservation)
        {
            ...
            {
                // Ensure reverse connection cleanup only if it points to this table
