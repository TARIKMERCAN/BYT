...
namespace RestaurantManagementSystem.Models
{
    public class Dish : SerializableObject<Dish>
    {
        ...
        public void AddOrderDish(OrderDish orderDish)
        {
            ...
            lock (_lock)
            {
                if (_orderDishes.Any(od => od.Dish == orderDish.Dish))
        ...
        public void RemoveIngredient(string ingredient)
        {
            ...
            lock (_lock)
            {
                ...
                OnIngredientRemoved?.Invoke($"Ingredient '{ingredient}' removed from Dish '{Name}'.");
                LogAction($"Ingredient '{ingredient}' removed from Dish '{Name}'.");
            }
        }
